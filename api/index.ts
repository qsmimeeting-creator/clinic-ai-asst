...
app.post("/api/chat", async (req, res) => {
  try {
    ...
    5. Call to Action & Human Handoff: ปิดท้ายด้วยสิ่งที่จะให้ผู้ใช้ทำต่อ (เช่น ถามว่าต้องการจองคิวไหม หรือต้องการสอบถามข้อมูลอื่นเพิ่มไหม) และ **ต้องมีข้อความนี้ต่อท้ายเสมอ**: "(หากต้องการติดต่อเจ้าหน้าที่ พิมพ์ 'ติดต่อแอดมิน' ได้เลยค่ะ/ครับ)"
    ...
    - ตรวจสอบว่ามี Medical Disclaimer และ Call to Action (ติดต่อแอดมิน) ปิดท้ายหรือไม่?
